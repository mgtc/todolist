...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TodoAddJs = __webpack_require__(8);
	
	var _TodoAddJs2 = _interopRequireDefault(_TodoAddJs);
	...
	var App = (function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function ajaxGetTodo() {
	            ...
	            _jquery2["default"].ajax({
	                ...
	                error: function error(xhr, status, err) {
	                    console.error(_this.apiUrl, status, err.toString());
	                }
	            });
	        }
	    }, {
	        key: "ajaxCreateTodo",
	        value: function ajaxCreateTodo(todoItem) {
	            var _this2 = this;
	            ...
	            _jquery2["default"].ajax({
	                ...
	                error: function error(xhr, status, err) {
	                    console.error(_this2.apiUrl, status, err.toString());
	                }
	            });
	        }
	    }, {
	        key: "ajaxUpdateTodo",
	        value: function ajaxUpdateTodo(todoIndex) {
	            var _this3 = this;
	            ...
	            _jquery2["default"].ajax({
	                ...
	                error: function error(xhr, status, err) {
	                    console.error(_this3.apiUrl, status, err.toString());
	                }
	            });
	        }
	    }, {
	        key: "ajaxDeleteTodo",
	        value: function ajaxDeleteTodo(todoId) {
	            var _this4 = this;
	            ...
	            _jquery2["default"].ajax({
	                ...
	                error: function error(xhr, status, err) {
	                    console.error(_this4.apiUrl, status, err.toString());
	                }
	            });
	        }
	    }, {
	        key: "TodoAdd",
	        value: function TodoAdd(todoItem) {
	            if (this.state.todos.length) {
	                var todosLength = this.state.todos.length;
	                var todosLastId = this.state.todos[todosLength - 1].id;
	        ...
	        value: function deleteTodo(index) {
	            var todoId = this.state.todos[index].id;
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "panel" },
	                _react2["default"].createElement(_TodoAddJs2["default"], { TodoAdd: this.TodoAdd.bind(this) }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoAdd = (function (_React$Component) {
	    ...
	    function TodoAdd() {
	        ...
	        _get(Object.getPrototypeOf(TodoAdd.prototype), "constructor", this).apply(this, arguments);
	    }
	    ...
	    _createClass(TodoAdd, [{
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "ui input" },
	                _react2["default"].createElement("input", { onKeyUp: this.handlerKeyUp.bind(this), type: "text", placeholder: "New todo", ref: "input" }),
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { ref: 'deleteBtn', onClick: this.handlerDelete.bind(this), style: { 'display': 'inline' }, className: 'fr' },
	                    'Delete'
	                )
	            );
	        }
